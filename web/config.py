...
class Config(object):
    ...
    AWS_SNS_JOB_REQUEST_TOPIC = \
        "arn:aws:sns:us-east-1:659248683008:zhicongm_job_requests"
    AWS_SNS_JOB_COMPLETE_TOPIC = \
        "arn:aws:sns:us-east-1:659248683008:zhicongm_job_results"
    AWS_SNS_RESTORE_START_TOPIC = \
        "arn:aws:sns:us-east-1:659248683008:zhicongm_restore_start"

    # Change the table name to your own
    AWS_DYNAMODB_ANNOTATIONS_TABLE = "zhicongm_annotations"

    # Change the email address to your username
    MAIL_DEFAULT_SENDER = "zhicongm@mpcs-cc.com"
